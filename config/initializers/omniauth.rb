...
Rails.application.config.middleware.use OmniAuth::Builder do
  ...
  provider :google_oauth2, '1095677510377-98krukjir1j472p4q3g7gb18oej274t2.apps.googleusercontent.com', '4UQ2tXPd9fIaUrOLuNdS9lEl', {:scope => "email, profile, http://gdata.youtube.com"}
end
